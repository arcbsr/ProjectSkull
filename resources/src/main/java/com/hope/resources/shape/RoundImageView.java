package com.hope.resources.shape;
...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRadius = a.getDimensionPixelSize(R.styleable.RoundImageView_rv_radius, 6);
        a.recycle();
        init();
    }
...
//        mBitmapPaint.setColorFilter(mColorFilter);
    ...
    private void setup() {
        ...
        mBorderRect = new RectF(mBorderWidth, mBorderWidth, getWidth() - mBorderWidth, getHeight() - mBorderWidth);
